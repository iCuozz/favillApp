...
/// Mini-game RINCORSA — beach Temple-Run: insegui Lex che gattonava verso il mare.
///
  ...
  void _onCollision(_Obstacle obs) {
    ...
    for (int i = 0; i < 10; i++) {
      _particles.add(_Particle(
        ...
        color: Color.lerp(const Color(0xFFFFD700), const Color(0xFFFF6B35),
            _rng.nextDouble())!,
        life: 1.0,
        ...
        child: Container(
          decoration: const BoxDecoration(
            gradient: LinearGradient(
              ...
              colors: [Color(0xFF1A4068), Color(0xFF0D2035)],
            ),
          ),
          child: Padding(
      ...
      children: [
        ...
        Container(
          ...
          decoration: BoxDecoration(
            ...
            boxShadow: [
              BoxShadow(
                color: (stunned ? Colors.red : const Color(0xFFFFB300))
                    .withOpacity(stunned ? 0.7 : 0.4),
                blurRadius: 18,
                spreadRadius: stunned ? 6 : 2,
              ),
            ],
          ),
        ),
